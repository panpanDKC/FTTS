...
from PyQt6.QtGui import QPalette, QColor, QPixmap, QImage, QBrush
...
class MainWindow(QWidget):
    def __init__(self,mode,ind):
        ...
        oImage = QImage("ressources/FTTS_backv4.png")
        if oImage.isNull():
            raise Exception("""You are missing an image ! 
           Go download 'ressources/FTTS_backv4.png' 
        ...
        self.chooseGame.setGeometry(560,10,280,30)
        ...
        self.List.setGeometry(605,660,350,30)

        rect_select = QLabel(self)
        rect_select.setGeometry(601+self.ListInd*43,656,30,30)
        ...
        self.indicA.setGeometry(560,630,280,30)
        ...
        self.indicB.setGeometry(560,35,280,30)
        ...
        if mode:
            ...
            if self.ListInd == 2:
                rect_select.setGeometry(601+self.ListInd*43,656,42,30)
        else:
        ...
        self.wpm.setGeometry(510,330,120,70)
        ...
        self.accu.setGeometry(640,330,120,70)

        #Set the text cursor
        self.cursor = QLabel(self)
        self.cursor.setFont(QFont('Andale Mono',18))
        self.cursor.setText("|")
        self.cursor.setGeometry(int(self.rect.left())+15,
        ...
        self.time.setGeometry(740,352,120,20)
